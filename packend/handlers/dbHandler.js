...
const tippersHandler = require("./tippersHandler")
...
module.exports.sendQuery = async (req, res) => {
    ...
    for(var statement of sqlStatements){
        ...
        else if(statement.includes("where")){
            hasWhere = true
    ...
    if(hasWhere){
        selectStatement = selectStatement + whereStatement
    }
    ...
    try {
        ...
        const buildings = await tippersHandler.getBuildings()
        res.json({shapedData, visualization, buildings})  
